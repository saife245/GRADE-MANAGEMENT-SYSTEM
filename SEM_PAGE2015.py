...
def vp_start_gui():
    ...
    root = Tk()
    top = SEMESTER (root)
    SEM_PAGE_support2015.init(root, top)
    root.mainloop()
...
def create_SEMESTER(root, *args, **kwargs):
    ...
    w = Toplevel (root)
    top = SEMESTER (w)
    SEM_PAGE_support2015.init(w, top, *args, **kwargs)
    return (w, top)
...
class SEMESTER:
    ...
    def evensem2015(self):
        import EVEN_SEM2015
        EVEN_SEM2015.vp_start_gui()
    ...
    def __init__(self, top=None):
        ...
        self.Button1.configure(command=self.oddsem2015)
        ...
        self.Button2.configure(command=self.evensem2015)
