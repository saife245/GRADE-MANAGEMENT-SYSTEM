...
def vp_start_gui():
    ...
    root = Tk()
    top = SEMESTER (root)
    SEM_PAGE_support2016.init(root, top)
    root.mainloop()
...
def create_SEMESTER(root, *args, **kwargs):
    ...
    w = Toplevel (root)
    top = SEMESTER (w)
    SEM_PAGE_support2016.init(w, top, *args, **kwargs)
    return (w, top)
...
class SEMESTER:
    def oddsem2016(self):
        import ODD_SEM2016
        ODD_SEM2016.vp_start_gui()

    def evensem2016(self):
        import EVEN_SEM2016
        EVEN_SEM2016.vp_start_gui()
    ...
    def __init__(self, top=None):
        ...
        self.Button1.configure(command=self.oddsem2016)
        ...
        self.Button2.configure(command=self.evensem2016)
