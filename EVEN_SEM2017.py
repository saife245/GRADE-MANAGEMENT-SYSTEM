...
def vp_start_gui():
    ...
    EVEN_SEM_support2017.init(root, top)
    root.mainloop()
...
def create_SELECT_SEMESTER(root, *args, **kwargs):
    ...
    EVEN_SEM_support2017.init(w, top, *args, **kwargs)
    return (w, top)
...
class SELECT_SEMESTER:
    def back(self):
        EVEN_SEM_support2017.destroy_window()
        import SEM_PAGE2017
    ...
    def __init__(self, top=None):
        ...
        self.Button1.configure(text='''2ND SEM''')
        ...
        self.Button2.configure(text='''4TH SEM''')
        ...
        self.Button3.configure(text='''6TH SEM''')
        ...
        self.Button4.configure(text='''8TH SEM''')
