...
def vp_start_gui():
    ...
    root = Tk()
    top = SEMESTER (root)
    SEM_PAGE_support2018.init(root, top)
    root.mainloop()
...
def create_SEMESTER(root, *args, **kwargs):
    ...
    w = Toplevel (root)
    top = SEMESTER (w)
    SEM_PAGE_support2018.init(w, top, *args, **kwargs)
    return (w, top)
...
class SEMESTER:
    ...
    def evensem2018(self):
        import EVEN_SEM2018
        EVEN_SEM2018.vp_start_gui()
    ...
    def __init__(self, top=None):
        ...
        self.Button1.configure(command=self.oddsem2018)
        ...
        self.Button2.configure(command=self.evensem2018)
